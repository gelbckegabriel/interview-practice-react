            ...
            <section className="px-5 pb-6 border-t border-zinc-100 dark:border-zinc-800 space-y-8 text-sm leading-7 pt-6">
              <div>
                ...
                <p className="text-zinc-600 dark:text-zinc-400">
                  A travel-planning startup wants a small internal dashboard so employees can check the current weather and
                  an upcoming forecast for any city in the world. Ops does not want to manage API keys or secrets for an
                  internal tool, so this must run against a free, keyless public weather API.
                </p>
              </div>
              ...
              <div>
                ...
                <ol className="list-decimal list-outside ml-5 space-y-3 text-zinc-600 dark:text-zinc-400">
                  ...
                  <li>
                    Once a location is chosen, fetch <strong>current conditions</strong> and a <strong>forecast covering at
                    least the next 5 days</strong> from the <strong>Open-Meteo Forecast API</strong>.
                  </li>
                  <li>
                    Display current conditions prominently: temperature, &ldquo;feels like&rdquo; (apparent) temperature, wind
                    speed, and a human-readable condition description. Open-Meteo returns a numeric weather code &mdash; you
                    must map codes to descriptions (and/or icons) yourself.
                  </li>
                  <li>
                  ...
                  <li>
                    All requests to Open-Meteo must go through a <strong>Next.js Route Handler</strong>. The client must
                    never call Open-Meteo directly.
                  </li>
                  <li>
                    Implement your <strong>own in-memory server-side cache with a TTL</strong> (e.g. 10 minutes), keyed by
                    location, so that repeated searches for the same city do not re-hit Open-Meteo. The cache must expire
                    entries correctly.
                  </li>
                  <li>
                  ...
                  <li>
                    Show <strong>loading indicators</strong> for the geocoding step and the forecast step separately &mdash;
                    they are two sequential network calls.
                  </li>
                </ol>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-outside ml-5 space-y-2 text-zinc-600 dark:text-zinc-400">
                  ...
                  <li>
                    No API key of any kind &mdash; use only Open-Meteo&rsquo;s free, keyless endpoints.
                  </li>
                  <li>No UI component libraries. Tailwind CSS is already installed and available.</li>
                  <li>
                    TypeScript is required. Type only the response fields you actually consume.
                  </li>
                  <li>
                    The cache must be your own hand-rolled logic (e.g. a module-level <code>Map</code> plus timestamps) &mdash;
                    not Next.js&rsquo;s built-in fetch cache or the <code>use cache</code> directive. The point of this
                    exercise is to practice writing your own expiry logic.
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-zinc-600 dark:text-zinc-400 mb-3">
                  A working page at <code>/challenge-003</code> (this page, which you will replace with your implementation)
                  that satisfies all requirements above. The evaluator will:
                </p>
                <ul className="list-disc list-outside ml-5 space-y-2 text-zinc-600 dark:text-zinc-400">
                  <li>Search for a real city (e.g. <code>Toronto</code>) and verify current conditions and the forecast look plausible.</li>
                  <li>Search an ambiguous name (e.g. <code>Paris</code> or <code>London</code>) and confirm a disambiguation list with multiple countries appears.</li>
                  <li>Search a nonsense string and confirm a clean &ldquo;not found&rdquo; message, with no crash.</li>
                  <li>
                    Search the same city twice within the TTL window and confirm (via the Network tab, or a cache indicator
                    you add) that the second search does not re-hit Open-Meteo.
                  </li>
              ...
              <div>
                ...
                <ul className="list-disc list-outside ml-5 space-y-2 text-zinc-600 dark:text-zinc-400">
                  ...
                  <li>
                    A &ldquo;use my location&rdquo; button using the browser Geolocation API, reverse-geocoded through
                    Open-Meteo.
                  </li>
